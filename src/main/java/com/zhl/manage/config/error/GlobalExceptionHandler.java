package com.zhl.manage.config.error;


import com.zhl.manage.utils.ExceptionEnum;
import com.zhl.manage.utils.ShiroFilterUtils;
 ...
 * </br>ControllerAdvice来做controller内部的全局异常处理，但对于未进入controller前的异常，
 * 该处理方法是无法进行捕获处理的，SpringBoot提供了ErrorController的处理类来处理所有的异常(TODO)。
...
public class GlobalExceptionHandler {
	...
	/**
	 * 
	 * @描述：处理UnknownSessionException异常【无效！！！因为未进入到controller之前出现，
	 * 在sessionManager管理器的时候已经抛出异常】
	 * @param req
	 * @param e
	 * @return
	 * @throws Exception
